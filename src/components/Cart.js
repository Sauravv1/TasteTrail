...
const Cart = () => {
  ...
  return (
    <div className="mx-auto max-w-3xl my-4 shadow-2xl p-4">
      <div className="text-center font-bold text-xl my-8">Let's Pack!</div>
      {!isCartEmpty && (
        <div>
          <button
            className="bg-gray-600 hover:bg-red-600 m-2 text-white rounded p-1 text-xs my-4"
            onClick={handleClear}
          >
            Clear Cart
          </button>
          ...
          <hr />
          <h2 className="underline text-sm mt-2 font-serif">Bill Details</h2>
          <div className="m-2 flex flex-col sm:flex-row justify-between">
            <div className="m-1">
              <ul>
          ...
          <hr className="h-px bg-gray-300 border-0 my-2" />
          <div className="m-2 flex flex-col sm:flex-row justify-between">
            <div className="m-1">
              <ul>
          ...
          <div className="text-center">
            <button
              className="text-sm px-4 py-2 hover:bg-teal-700 bg-green-600 text-white mt-2 rounded min-w-[80px]"
              onClick={handlePlaceOrder}
            >
              Place Order
            </button>
          </div>
          <p className="text-[0.64rem] text-gray-400 text-center font-serif my-2">
            Note: The bill section for cart is static.
          </p>
        </div>
      )}
      ...
      {isCartEmpty && (
        <h1 className="text-center my-40 text-lg font-serif">
          Your cart looks empty. Please add items to proceed.
        </h1>
      )}
    </div>
  );
