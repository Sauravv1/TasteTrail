...
const Footer = () => {
  return (
    <div><footer class="flex flex-col space-y-10 justify-center m-10">
    ...
    <p class="text-center text-gray-700 font-medium">&copy; 2024 TasteTrail. All rights reservered.</p>
</footer></div>
